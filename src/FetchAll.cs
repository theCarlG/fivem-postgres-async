...
namespace PostgresAsync
{
    class FetchAll : Operation<List<Dictionary<string, Object>>>
    {
        ...
        protected override List<Dictionary<string, object>> Reader(NpgsqlCommand command)
        {
        ...
        protected async override Task<List<Dictionary<string, object>>> ReaderAsync(NpgsqlCommand command)
        {
            var results = new List<Dictionary<string, Object>>();
